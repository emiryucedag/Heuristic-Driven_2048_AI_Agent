...
class Game2048(tk.Frame):
    def __init__(self):
        ...
        self.master.bind("s", lambda event: self.run_simulation(num_games=10, test_depth=4))
        self.master.bind("c", lambda event: self.run_cache_test())
        self.master.bind("d", lambda event: self.run_ablation_test())
